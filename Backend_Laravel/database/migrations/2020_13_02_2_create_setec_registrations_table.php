...
class CreateSetecRegistrationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        //matriculas
        Schema::connection('pgsql-cecy')->create('setec_registrations', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('planification_id')->constrained('setec_planifications'); //id_planificación
            $table->timestamps();
        });
    }
    ...
    {
        Schema::connection('pgsql-cecy')->dropIfExists('setec_registrations');
    }
}
