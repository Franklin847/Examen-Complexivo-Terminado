...
class CreateSetecDetailRegistrationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        //detalle_matriculas
        Schema::connection('pgsql-cecy')->create('setec_detail_registrations', function (Blueprint $table) {
            $table->id();
            $table->foreignId('registration_id')->constrained('setec_registrations'); //id_matricula
